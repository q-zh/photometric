...
class BaseOpts(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--int_aug',     default=False,  action='store_false')
        self.parser.add_argument('--noise_aug',   default=False,  action='store_false')
        ...
        self.parser.add_argument('--item',       default='TPAMI')
